            ...
            out string className)
        {
            ...
            (
                ...
                (
                    ...
                    SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("NippyWard.NCurses.Interop")),
                    SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("NippyWard.NCurses.Interop.SingleByte"))
                )
                .AddMembers
                (
                    SyntaxFactory.NamespaceDeclaration(SyntaxFactory.ParseName("NippyWard.NCurses.Generated"))
                    .AddMembers(newRoot)
                    .NormalizeWhitespace()
                )
                .NormalizeWhitespace(),
            ...
            out string className)
        {
            ...
            (
                ...
                (
                    ...
                    SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("System.Runtime.CompilerServices")),
                    SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("NippyWard.NCurses.Interop")),
                    SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("NippyWard.NCurses.Interop.MultiByte"))
                )
                .AddMembers
                (
                    SyntaxFactory.NamespaceDeclaration(SyntaxFactory.ParseName("NippyWard.NCurses.Generated"))
            ...
            out string className)
        {
            ...
            (
                ...
                (
                    ...
                    SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("System.Runtime.InteropServices")),
                    SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("NippyWard.NCurses.Interop")),
                    SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("NippyWard.NCurses.Interop.Mouse"))
                )
                .NormalizeWhitespace()
                .AddMembers
                (
            ...
            out string className)
        {
            ...
            (
                ...
                (
                    SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("System")),
                    SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("System.Runtime.InteropServices")),
                    SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("NippyWard.NCurses.Interop.SafeHandles")),
                    SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("NippyWard.NCurses.Interop.Panel"))
                )
                .NormalizeWhitespace()
                .AddMembers
                (
            ...
            (
                SyntaxFactory.CompilationUnit()
                    ...
                    (
                        ...
                        SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("NippyWard.NCurses.Interop.MultiByte")),
                        SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("NippyWard.NCurses.Interop.Mouse")),
                        SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("NippyWard.NCurses.Interop.WideChar")),
                        SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("NippyWard.NCurses.Interop.Char"))
                    )
                    .NormalizeWhitespace()
                    .AddMembers
                    (
