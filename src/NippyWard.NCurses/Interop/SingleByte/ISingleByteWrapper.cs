...
namespace NippyWard.NCurses.Interop.SingleByte
{
        ...
        where TMouseEvent : unmanaged, IMEVENT
    {
        ...
        int attr_get(ref TSingleByte attrs, ref short pair, ref int opts);
        //int attr_off(attr_t attrs, void *opts);
        int attr_off(TSingleByte attrs, IntPtr opts);
        //int attr_on(attr_t attrs, void *opts);
        int attr_on(TSingleByte attrs, IntPtr opts);
        //int attr_set(attr_t attrs, short pair, void *opts);
        int attr_set(TSingleByte attrs, short pair, ref int opts);
        //int bkgd(chtype ch);
        ...
        int wattr_get(WindowBaseSafeHandle win, ref TSingleByte attrs, ref short pair, ref int opts);
        ...
        int wattr_set(WindowBaseSafeHandle win, TSingleByte attrs, short pair, ref int opts);
