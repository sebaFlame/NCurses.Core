...
namespace NCurses.Core.Interop.MultiByteString
{
        ...
        where TSingleByteString : unmanaged
    {
        ...
        int get_wch(ref TMultiByteString wch); //max 4 bytes (gets casted from an integer)
        //int get_wstr(wint_t *wstr);
        int get_wstr(ref TMultiByteString wstr);
        //int getn_wstr(wint_t *wstr, int n);
        int getn_wstr(ref TMultiByteString wstr, int n);
        ...
        int mvget_wch(int y, int x, ref TMultiByteString wch);
        //int mvget_wstr(int y, int x, wint_t *wstr);
        int mvget_wstr(int y, int x, ref TMultiByteString wstr);
        ...
        //int mvwget_wch(WINDOW *win, int y, int x, wint_t *wch);
        int mvwget_wch(IntPtr window, int y, int x, ref TMultiByteString wch);
        //int mvwget_wstr(WINDOW *win, int y, int x, wint_t *wstr);
        int mvwget_wstr(IntPtr window, int y, int x, ref TMultiByteString wstr);
        //int mvwgetn_wstr(WINDOW *win, int y, int x, wint_t *wstr, int n);
        int mvwgetn_wstr(IntPtr window, int y, int x, ref TMultiByteString wstr, int n);
        ...
        int wget_wch(IntPtr window, ref TMultiByteString wch);
        //int wget_wstr(WINDOW *win, wint_t *wstr);
        int wget_wstr(IntPtr window, ref TMultiByteString wstr);
        //int wgetn_wstr(WINDOW *win, wint_t *wstr, int n);
        int wgetn_wstr(IntPtr window, ref TMultiByteString wstr, int n);
