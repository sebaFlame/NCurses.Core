...
{
    public interface INativeStdScrSingleByteString
    {
    ...
    public class NativeStdScrSingleByteString<TSingleByteString> : SingleByteStringWrapper<TSingleByteString>, INativeStdScrSingleByteString
        where TSingleByteString : unmanaged
    {
        ...
        public void getnstr(out string str, int count)
        {
            unsafe
            {
                ...
                NCursesException.Verify(this.Wrapper.getnstr(ref MarshalString(strPtr, count, out Span<TSingleByteString> span), count), "getnstr");
        ...
        public void getstr(out string str)
        {
            unsafe
            {
                ...
                NCursesException.Verify(this.Wrapper.getstr(ref MarshalString(strPtr, Constants.MAX_STRING_LENGTH, out Span<TSingleByteString> span)), "getstr");
                str = ReadString(ref span);
            }
        }
        ...
        public void innstr(out string str, int count, out int read)
        {
            ...
            {
                TSingleByteString* strPtr = stackalloc TSingleByteString[count];
                read = this.Wrapper.innstr(ref MarshalString(strPtr, count, out Span<TSingleByteString> span), count);
        ...
        public void instr(out string str, out int read)
        {
            ...
            {
                TSingleByteString* strPtr = stackalloc TSingleByteString[Constants.MAX_STRING_LENGTH];
                read = this.Wrapper.instr(ref MarshalString(strPtr, Constants.MAX_STRING_LENGTH, out Span<TSingleByteString> span));
        ...
        public void mvgetnstr(int y, int x, out string str, int count)
        {
            ...
            {
                TSingleByteString* strPtr = stackalloc TSingleByteString[count];
                NCursesException.Verify(this.Wrapper.mvgetnstr(y, x, ref MarshalString(strPtr, count, out Span<TSingleByteString> span), count), "mvgetnstr");
                str = ReadString(ref span);
            }
        }
        ...
        public void mvgetstr(int y, int x, out string str)
        {
            ...
            {
                TSingleByteString* strPtr = stackalloc TSingleByteString[Constants.MAX_STRING_LENGTH];
                NCursesException.Verify(this.Wrapper.mvgetstr(y, x, ref MarshalString(strPtr, Constants.MAX_STRING_LENGTH, out Span<TSingleByteString> span)), "mvgetstr");
                str = ReadString(ref span);
            }
        }
        ...
        public void mvinnstr(int y, int x, out string str, int n, out int read)
        {
            unsafe
            {
                ...
                read = this.Wrapper.mvinnstr(y, x, ref MarshalString(strPtr, n, out Span<TSingleByteString> span), n);
        ...
        public void mvinstr(int y, int x, out string str, out int read)
        {
            ...
            {
                TSingleByteString* strPtr = stackalloc TSingleByteString[Constants.MAX_STRING_LENGTH];
                read = this.Wrapper.mvinstr(y, x, ref MarshalString(strPtr, Constants.MAX_STRING_LENGTH, out Span<TSingleByteString> span));
