...
namespace NCurses.Core.Interop
{
    public interface INCursesWrapper
    {
        ...
        int attr_off(chtype attrs, IntPtr opts);
        int attr_on(chtype attrs, IntPtr opts);
        int attr_set(chtype attrs, short pair, IntPtr opts);
        ...
        int bkgd(chtype bkgd);
        void bkgdset(chtype bkgd);
        ...
        chtype getbkgd(IntPtr window);
        int getbkgrnd(IntPtr wch);
        int getcchar(IntPtr wcval, IntPtr wch, out chtype attrs, out short color_pair, IntPtr opts);
        int getch();
        ...
        chtype mousemask(chtype newmask, out chtype oldmask);
        chtype mousemask_sp(IntPtr screen, chtype newmask, ref chtype? oldmask);
        ...
        int mvchgat(int y, int x, int number, chtype attrs, short pair);
        ...
        int mvwaddch(IntPtr window, int y, int x, chtype ch);
        ...
        int mvwchgat(IntPtr window, int y, int x, int number, chtype attrs, short pair);
        ...
        int mvwhline(IntPtr window, int y, int x, chtype ch, int count);
        ...
        chtype mvwinch(IntPtr window, int y, int x);
        ...
        int mvwinsch(IntPtr window, int y, int x, chtype ch);
        ...
        int mvwvline(IntPtr window, int y, int x, chtype ch, int n);
        ...
        int pechochar(IntPtr pad, chtype ch);
        ...
        int setcchar(IntPtr wcval, IntPtr wch, chtype attrs, short color_pair, IntPtr opts);
        int setscrreg(int top, int bot);
        chtype slk_attr();
        int slk_attr_off(chtype attrs, IntPtr opts);
        int slk_attr_on(chtype attrs, IntPtr opts);
        int slk_attr_set(chtype attrs, short color_pair, IntPtr opts);
        int slk_attr_set_sp(IntPtr screen, chtype attrs, short color_pair, IntPtr opts);
        chtype slk_attr_sp(IntPtr screen);
        int slk_attroff(chtype attrs);
        int slk_attroff_sp(IntPtr screen, chtype attrs);
        int slk_attron(chtype attrs);
        int slk_attron_sp(IntPtr screen, chtype attrs);
        int slk_attrset(chtype attrs, short color_pair, IntPtr opts);
        int slk_attrset_sp(IntPtr screen, chtype attrs, short color_pair, IntPtr opts);
        int slk_clear();
        ...
        chtype term_attrs();
        chtype term_attrs_sp(IntPtr screen);
        chtype termattrs();
        chtype termattrs_sp(IntPtr screen);
        string termname();
        ...
        int vid_attr(chtype attrs, short pair, IntPtr opts);
        int vid_attr_sp(IntPtr screen, chtype attrs, short pair, IntPtr opts);
        int vid_puts(chtype attrs, short pair, IntPtr opts, IntPtr OUTC);
        int vid_puts_sp(IntPtr screen, chtype attrs, short pair, IntPtr opts, IntPtr OUTC);
        int vidattr(chtype attrs);
        int vidattr_sp(IntPtr screen, chtype attrs);
        int vidputs(chtype attrs, IntPtr OUTC);
        int vidputs_sp(IntPtr screen, chtype attrs, IntPtr OUTC);
        ...
        int waddch(IntPtr window, chtype ch);
        ...
        int wattr_get(IntPtr window, out chtype attrs, out short pair, IntPtr opts);
        int wattr_off(IntPtr window, chtype attrs, IntPtr opts);
        int wattr_on(IntPtr window, chtype attrs, IntPtr opts);
        int wattr_set(IntPtr window, chtype attrs, short pair, IntPtr opts);
        int wattroff(IntPtr window, int attrs);
        int wattron(IntPtr window, int attrs);
        int wattrset(IntPtr window, int attrs);
        int wbkgd(IntPtr window, chtype bkgd);
        void wbkgdset(IntPtr window, chtype bkgd);
        void wbkgrndset(IntPtr window, IntPtr wch);
        int wborder(IntPtr window, chtype ls, chtype rs, chtype ts, chtype bs, chtype tl, chtype tr, chtype bl, chtype br);
        int wborder_set(IntPtr window, IntPtr ls, IntPtr rs, IntPtr ts, IntPtr bs, IntPtr tl, IntPtr tr, IntPtr bl, IntPtr br);
        int wchgat(IntPtr window, int number, chtype attrs, short pair, IntPtr opts);
        ...
        int wechochar(IntPtr window, chtype ch);
        ...
        int whline(IntPtr window, chtype ch, int count);
        ...
        int winsch(IntPtr window, chtype ch);
        ...
        int wvline(IntPtr window, chtype ch, int n);
