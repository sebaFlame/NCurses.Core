...
namespace NCurses.Core
{
    public interface IWindow : IEquatable<IWindow>, IDisposable
    {
        ...
        void Write(ReadOnlySequence<byte> str, Encoding encoding);
        void Write(byte[] str, Encoding encoding, ulong attrs, ushort pair);
        void Write(ReadOnlySpan<byte> str, Encoding encoding, ulong attrs, ushort pair);
        void Write(ReadOnlySequence<byte> str, Encoding encoding, ulong attrs, ushort pair);
        void Write(char ch);
        ...
        void Write(int nline, int ncol, ReadOnlySequence<byte> str, Encoding encoding);
        void Write(int nline, int ncol, byte[] str, Encoding encoding, ulong attrs, ushort pair);
        void Write(int nline, int ncol, ReadOnlySpan<byte> str, Encoding encoding, ulong attrs, ushort pair);
        void Write(int nline, int ncol, ReadOnlySequence<byte> str, Encoding encoding, ulong attrs, ushort pair);
        ...
        void Write(ReadOnlySequence<byte> str, int maxLength, Encoding encoding);
