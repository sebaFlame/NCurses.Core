...
namespace NCurses.Core
{
    public class MultiBytePad : Pad
    {
        ...
        public MultiBytePad(IntPtr windowPtr, bool ownsHandle = true, bool initizalize = true)
            : base(windowPtr, ownsHandle, initizalize)
        {
            this.Window = new MultiByteWindow(this.WindowPtr, false);
        }

        internal MultiBytePad(MultiByteWindow window)
        ...
        {
            MultiByteCharFactory.Instance.GetNativeChar(ch, out IMultiByteChar wch);
            NativePad.pecho_wchar(this.WindowPtr, wch);
        }

        public override Window Duplicate()
        {
            return new MultiBytePad(new MultiByteWindow(NativeNCurses.dupwin(this.WindowPtr), false));
        }
        ...
        {
            return new SingleBytePad(this.WindowPtr, false);
        }
